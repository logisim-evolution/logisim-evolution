...
public class Ttl7464 extends AbstractTtlGate {
	...
	public Ttl7464() {
		super("7464", (byte) 14, new byte[] { 8 },
				new String[] { "A", "E", "F", "G", "H", "I", "Y", "J", "K", "B", "C", "D"},70);
	}
	...
	public void paintInternal(InstancePainter painter, int x, int y, int height, boolean up) {
		...
		ypos = new int[] {y+height-AbstractTtlGate.pinheight,y+height-12,y+height-12,y+53,y+53};
		g.drawPolyline(xpos, ypos, 5);
	}
	...
	public boolean HDLSupportedComponent(String HDLIdentifier,
		...
		if (MyHDLGenerator == null)
			MyHDLGenerator = new Ttl7464HDLGenerator();
