...
public class Propagator {
  ...
  private volatile Thread propagatorThread;
  ...
  public Propagator(CircuitState root) {
    ...
    propagatorThread = root.getProject().getSimulator().simThread;
    updateRandomness();
    updateSimLimit();
  }
  ...
  public void setPropagatorThread(Thread propagatorThread) {
    this.propagatorThread = propagatorThread != null ? propagatorThread : root.getProject().getSimulator().simThread;
  }
