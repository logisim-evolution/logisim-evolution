...
public class VhdlSimulatorVhdlTop {
  ...
  public void generate(List<Component> comps) {
    ...
    ports.append(StringUtil.format("Autogenerated by %s --", BuildInfo.displayName));
    ports.append(lineSeparator);

    final var components = new StringBuilder();
    components.append(StringUtil.format("Autogenerated by %s --", BuildInfo.displayName));
    components.append(lineSeparator);

    final var map = new StringBuilder();
    map.append(StringUtil.format("Autogenerated by %s --", BuildInfo.displayName));
