...
public class InstructionRegister {
    ...
    public int func3() { return (int) ((value >> 11) & ((1 << 3)-1)); } // value[14:12]
    public int rs1() { return (int) ((value >> 14) & ((1 << 5)-1)); }   // value[19:15]
    public int rs2() { return (int) ((value >> 19) & ((1 << 5)-1)); }   // value[24:20]
    public int func7() { return (int) ((value >> 24) & ((1 << 7)-1)); } // value[31:25]

    // I-type additional fields

    public long imm_I() {  // sign-extended immediate field of I-type instruction
        long res = ((value >> 19) & ((1 << 12) - 1)); // value[31:20], zero extended
