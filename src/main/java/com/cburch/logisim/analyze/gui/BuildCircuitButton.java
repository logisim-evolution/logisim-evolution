  ...
  private class MyListener implements ActionListener {
    public void actionPerformed(ActionEvent event) {
      ...
      while (!ok) {
        ...
        for (var label : model.getInputs().getNames()) labels.add(label.toUpperCase());
        for (var label : model.getOutputs().getNames()) labels.add(label.toUpperCase());
        ...
        if (dest != null) {
          ...
          for (var circ : dest.getLogisimFile().getCircuits()) {
