...
public class ArithmeticLibrary extends Library {
  ...
  private static final FactoryDescription[] DESCRIPTIONS = {
    ...
    new FactoryDescription(FpPower.class, S.getter("fpPowerComponent"), "power.gif"),
    new FactoryDescription(FpExponent.class, S.getter("fpExponentComponent"), "exponent.gif"),
