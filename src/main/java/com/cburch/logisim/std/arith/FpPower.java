...
public class FpPower extends InstanceFactory {
  /**
   ...
   */
  public static final String _ID = "FPPower";
  ...
  public FpPower() {
    super(_ID, S.getter("fpPowerComponent"));
    ...
    ps[IN0].setToolTip(S.getter("powerInputATip"));
    ps[IN1].setToolTip(S.getter("powerInputBTip"));
    ps[OUT].setToolTip(S.getter("fpPowerOutputTip"));
  ...
  public void propagate(InstanceState state) {
    ...
    final var out_val = Math.pow(a_val, b_val);
