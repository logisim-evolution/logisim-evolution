...
public class ShifterHDLGeneratorFactory extends AbstractHDLGeneratorFactory {
  ...
  public SortedMap<String, String> GetPortMap(Netlist Nets, Object MapInfo, FPGAReport Reporter) {
    ...
    PortMap.putAll(GetNetMap("DataA", true, ComponentInfo, Shifter.IN0, Reporter, Nets));
    PortMap.putAll(GetNetMap("ShiftAmount", true, ComponentInfo, Shifter.IN1, Reporter, Nets));
    PortMap.putAll(GetNetMap("Result", true, ComponentInfo, Shifter.OUT, Reporter, Nets));
    return PortMap;
  }
