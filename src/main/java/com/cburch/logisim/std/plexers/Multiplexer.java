...
public class Multiplexer extends InstanceFactory {
  ...
  public void paintGhost(InstancePainter painter) {
    ...
    int lean;
    if (select.getWidth() == 1) lean = (size == PlexersLibrary.SIZE_NARROW ? 7 : 10);
    else lean = (size == PlexersLibrary.SIZE_NARROW ? 10 : 20);
  ...
  public void paintInstance(InstancePainter painter) {
    ...
    int lean;
    if (inputs == 2) {
      lean = (size == PlexersLibrary.SIZE_NARROW ? 7 : 10);
    } else {
      lean = (size == PlexersLibrary.SIZE_NARROW ? 10 : 20);
    }
  ...
  private void updatePorts(Instance instance) {
    ...
    boolean botLeft = selectLoc == PlexersLibrary.SELECT_BOTTOM_LEFT;
