  ...
  public static List<String> getComponentMap(char typeId, int nrOfRows, int nrOfColumns, int identifier, long FpgaClockFrequency, boolean isActiveLow) {
    ...
    switch (typeId) {
      case SevenSegmentScanningDriving.SEVEN_SEG_DECODED:
        componentMap.add(SevenSegmentScanningDecodedHdlGeneratorFactory.getGenericMap(
            nrOfRows, nrOfColumns, FpgaClockFrequency, isActiveLow, false)
            .getWithIndent());
        break;
      case SevenSegmentScanningDriving.SEVEN_SEG_SCANNING_ACTIVE_HI, SevenSegmentScanningDriving.SEVEN_SEG_SCANNING_ACTIVE_LOW:
        componentMap.add(SevenSegmendScanningSelectedHdlGenerator.getGenericMap(nrOfRows, nrOfColumns, FpgaClockFrequency, isActiveLow,
    ...
    switch (typeId) {
      case SevenSegmentScanningDriving.SEVEN_SEG_DECODED,
          ...
          SevenSegmentScanningDriving.SEVEN_SEG_SCANNING_ACTIVE_LOW:
