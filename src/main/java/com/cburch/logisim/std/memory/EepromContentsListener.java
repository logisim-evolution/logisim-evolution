...
class EepromContentsListener implements HexModelListener {
  private static class Change extends Action {
    private final EepromContentsListener source;
    ...
    public String getName() {
      return S.get("eepromChangeAction");
    }
  ...
  EepromContentsListener(Project proj) {
    this.proj = proj;
  }
