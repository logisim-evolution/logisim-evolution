...
public class TTL extends Library {
  private static FactoryDescription[] DESCRIPTIONS = {
    ...
    new FactoryDescription(
        "7410", S.getter("7410: triple 3-input NAND gate"), "ttl.gif", "Ttl7410"),
    new FactoryDescription("7411", S.getter("7411: triple 3-input AND gate"), "ttl.gif", "Ttl7411"),
    new FactoryDescription(
        "7413", S.getter("7413: dual 4-input NAND gate(schmitt-trigger)"), "ttl.gif", "Ttl7413"),
    new FactoryDescription(
        "7414", S.getter("7414: hex inverter (schmitt-trigger)"), "ttl.gif", "Ttl7414"),
    new FactoryDescription(
        "7418", S.getter("7418: dual 4-input NAND gate(schmitt-trigger)"), "ttl.gif", "Ttl7418"),
    new FactoryDescription(
        "7419", S.getter("7419: hex inverter (schmitt-trigger)"), "ttl.gif", "Ttl7419"),
    ...
    new FactoryDescription(
        "7424", S.getter("7424: quad 2-input NAND gate (schmitt-trigger)"), "ttl.gif", "Ttl7424"),
    new FactoryDescription("7427", S.getter("7427: triple 3-input NOR gate"), "ttl.gif", "Ttl7427"),
    new FactoryDescription(
        "7430", S.getter("7430: single 8-input NAND gate"), "ttl.gif", "Ttl7430"),
    ...
    new FactoryDescription(
        "7443", S.getter("7443: Excess-3 to decimal decoder"), "ttl.gif", "Ttl7443"),
    new FactoryDescription("7444", S.getter("7444: Gray to decimal decoder"), "ttl.gif", "Ttl7444"),
    new FactoryDescription(
        "7447", S.getter("7447: BCD to 7-segment decoder"), "ttl.gif", "Ttl7447"),
    new FactoryDescription("7451", S.getter("7451: dual AND-OR-INVERT gate"), "ttl.gif", "Ttl7451"),
    new FactoryDescription(
        "7454", S.getter("7454: Four wide AND-OR-INVERT gate"), "ttl.gif", "Ttl7454"),
    new FactoryDescription("7458", S.getter("7458: dual AND-OR gate"), "ttl.gif", "Ttl7458"),
    new FactoryDescription(
        "7464", S.getter("7464: 4-2-3-2 AND-OR-INVERT gate"), "ttl.gif", "Ttl7464"),
    new FactoryDescription(
        "7474", S.getter("7474: dual D-Flipflops with preset and clear"), "ttl.gif", "Ttl7474"),
    new FactoryDescription(
        "7485", S.getter("7485: 4-bit magnitude comparator"), "ttl.gif", "Ttl7485"),
    new FactoryDescription("7486", S.getter("7486: quad 2-input XOR gate"), "ttl.gif", "Ttl7486"),
    new FactoryDescription(
        "74125",
        S.getter("74125: quad bus buffer, three-state outputs, negative enable"),
        "ttl.gif",
        "Ttl74125"),
    new FactoryDescription(
        "74175", S.getter("74175: quad D-flipflop, asynchronous reset"), "ttl.gif", "Ttl74175"),
    new FactoryDescription(
        "74165", S.getter("74165: 8-bit parallel-to-serial shift register"), "ttl.gif", "Ttl74165"),
    new FactoryDescription(
        "74266", S.getter("74266: quad 2-input XNOR gate"), "ttl.gif", "Ttl74266"),
    new FactoryDescription(
        "74273", S.getter("74273: octal D-Flipflop with clear"), "ttl.gif", "Ttl74273"),
    new FactoryDescription(
        "74283", S.getter("74283: 4-bit binary full adder"), "ttl.gif", "Ttl74283"),
    new FactoryDescription(
        "74377", S.getter("74377: octal D-Flipflop with enable"), "ttl.gif", "Ttl74377"),
  };
