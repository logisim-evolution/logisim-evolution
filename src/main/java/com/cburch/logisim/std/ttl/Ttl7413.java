...
public class Ttl7413 extends AbstractTtlGate {
  ...
  public Ttl7413(String id, String name, boolean inv) {
    super(name, pinCount, outPorts, unusedPorts, portNames, new Ttl7413HDLGenerator(id, inv));
    inverted = inv;
  }

  public Ttl7413(String id, String name) {
    super(name, pinCount, outPorts, unusedPorts, portNames, new Ttl7413HDLGenerator(id, true));
  }

  public Ttl7413() {
    super(_ID, pinCount, outPorts, unusedPorts, portNames, new Ttl7413HDLGenerator("TTL7413", true));
  }
