...
public class Ttl7454HDLGenerator extends AbstractHDLGeneratorFactory {
  ...
  public SortedMap<String, String> GetPortMap(Netlist Nets, Object MapInfo, FPGAReport Reporter) {
    ...
    PortMap.putAll(GetNetMap("B", true, ComponentInfo, 8, Reporter, Nets));
    PortMap.putAll(GetNetMap("C", true, ComponentInfo, 1, Reporter, Nets));
    PortMap.putAll(GetNetMap("D", true, ComponentInfo, 2, Reporter, Nets));
    PortMap.putAll(GetNetMap("E", true, ComponentInfo, 3, Reporter, Nets));
    PortMap.putAll(GetNetMap("F", true, ComponentInfo, 4, Reporter, Nets));
    PortMap.putAll(GetNetMap("G", true, ComponentInfo, 6, Reporter, Nets));
    PortMap.putAll(GetNetMap("H", true, ComponentInfo, 7, Reporter, Nets));
    PortMap.putAll(GetNetMap("Y", true, ComponentInfo, 5, Reporter, Nets));
    return PortMap;
  }
