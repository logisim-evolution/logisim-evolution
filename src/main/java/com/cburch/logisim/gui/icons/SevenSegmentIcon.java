...
public class SevenSegmentIcon extends BaseIcon {
  ...
  protected void paintIcon(Graphics2D g2) {
    ...
    final var iconColor = new Color(AppPreferences.COMPONENT_ICON_COLOR.get());
    final var inactiveColor = new Color(AppPreferences.COMPONENT_SECONDARY_COLOR.get());
    g2.setStroke(new BasicStroke(scale(2)));
    g2.setColor(iconColor);
    g2.drawRect(scale(2), 0, scale(10), scale(16));
    g2.setColor((segson & HexDigit.SEG_A_MASK) != 0 ? Color.RED : inactiveColor);
    g2.drawLine(scale(5), scale(3), scale(8), scale(3));
    g2.setColor((segson & HexDigit.SEG_B_MASK) != 0 ? Color.RED : inactiveColor);
    g2.drawLine(scale(9), scale(4), scale(9), scale(7));
    g2.setColor((segson & HexDigit.SEG_C_MASK) != 0 ? Color.RED : inactiveColor);
    g2.drawLine(scale(9), scale(9), scale(9), scale(12));
    g2.setColor((segson & HexDigit.SEG_D_MASK) != 0 ? Color.RED : inactiveColor);
    g2.drawLine(scale(5), scale(13), scale(8), scale(13));
    g2.setColor((segson & HexDigit.SEG_F_MASK) != 0 ? Color.RED : inactiveColor);
    g2.drawLine(scale(4), scale(4), scale(4), scale(7));
    g2.setColor((segson & HexDigit.SEG_E_MASK) != 0 ? Color.RED : inactiveColor);
    g2.drawLine(scale(4), scale(9), scale(4), scale(12));
    g2.setColor((segson & HexDigit.SEG_G_MASK) != 0 ? Color.RED : inactiveColor);
