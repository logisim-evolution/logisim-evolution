...
public class RegTabContent extends JScrollPane implements LocaleListener, Simulator.Listener {
  ...
  private void fillArray() {
    HashMap<String, Component> registers = new HashMap<>();
    for (final var circ : proj.getLogisimFile().getCircuits()) {
      getAllRegisters(circ, registers);
    }
    ...
    // This is called from the Simulation Thread, so make sure it doesn't block.
   ...
   */
  private static void getAllRegisters(Circuit circuit, Map<String, Component> registers) {
