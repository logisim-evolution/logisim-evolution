...
public class ColorBlindColors {
  ...
  public static final Color COMMON_BLACK = new Color(0, 0, 0);
  public static final Color COMMON_ORANGE = new Color(230, 159, 0);
  public static final Color COMMON_SKYBLUE = new Color(86, 180, 233);
  public static final Color COMMON_BLUISHGREEN = new Color(0, 158, 115);
  public static final Color COMMON_Yellow = new Color(240, 228, 66);
  public static final Color COMMON_BLUE = new Color(0, 114, 178);
  public static final Color COMMON_VERMILLION = new Color(213, 94, 0);
  public static final Color COMMON_REDDISHPURPLE = new Color(204, 121, 167);

  /* see: https://ux.stackexchange.com/questions/94696/color-palette-for-all-types-of-color-blindness */
  public static final Color[] PALETTE14 = {
    new Color(73, 0, 146),
    new Color(146, 0, 0),
    new Color(0, 73, 73),
    new Color(0, 109, 219),
  ...
  public static final String[] PALETTE14NAMES = {
    "MyPurple",
    "MyRedBrown",
    "MyNavyGreen",
    "MyNavyBlue",
