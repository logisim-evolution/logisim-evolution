...
<helpset version="2.0">
   ...
   <maps>
     <homeID>top</homeID>
     <mapref location="map_he.jhm" />
   </maps>
	
   <!-- views --> 
   <view xml:lang="he" mergetype="javax.help.UniteAppendMerge">
      <name>TOC</name>
      <label>Table Of Contents</label>
      <type>javax.help.TOCView</type>
      <data>he/contents.xml</data>
   </view>
  ...
  <view>
    ...
    <data engine="com.sun.java.help.search.DefaultSearchEngine">search_lookup_he</data>
  </view>
