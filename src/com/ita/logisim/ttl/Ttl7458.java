...
public class Ttl7458 extends AbstractTtlGate {
	...
	public Ttl7458() {
		super("7458", (byte) 14, new byte[] { 6,8 },
	...
	public void paintInternal(InstancePainter painter, int x, int y, int height, boolean up) {
		...
		int OrOffset = (AppPreferences.GATE_SHAPE.get().equals(AppPreferences.SHAPE_RECTANGULAR)) ? 4 : 0;
		...
		for (int i = 0 ; i < 3 ; i++) {
			g.drawLine(x+30+i*20, y+32+i*5, x+30+i*20, y+height-AbstractTtlGate.pinheight);
		...
		for (int i = 0 ; i < 5 ; i++) {
			...
			ypos = new int[] {i==0?y+height-AbstractTtlGate.pinheight:y+AbstractTtlGate.pinheight,
					          y+28-i*3,y+28-i*3};
			g.drawPolyline(xpos, ypos, 3);
		}
	...
	public boolean HDLSupportedComponent(String HDLIdentifier,
		...
		if (MyHDLGenerator == null)
			MyHDLGenerator = new Ttl7458HDLGenerator();
