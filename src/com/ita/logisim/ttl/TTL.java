...
public class TTL extends Library {
	private static FactoryDescription[] DESCRIPTIONS = {
			...
			new FactoryDescription("7442", Strings.getter("7442: 4-line BCD to 10-line decimal decoder"), "ttl.gif", "Ttl7442"),
			...
			new FactoryDescription("747266", Strings.getter("747266: quad 2-input XNOR gate"), "ttl.gif", "Ttl747266"), 
			};
