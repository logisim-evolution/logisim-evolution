...
public class ScaledTextField extends JTextField {
	...
	public ScaledTextField(Document doc, String text, int columns) {
		super(doc,text,columns);
		Init();
	}
	
	public ScaledTextField(int columns) {
		super(columns);
		Init();
	}
	
	public ScaledTextField(String text) {
		super(text);
		Init();
	}
	
	public ScaledTextField(String text, int columns) {
		super(text,columns);
		Init();
	}
