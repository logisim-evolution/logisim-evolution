...
public class ScaledMenuItem extends JMenuItem {
	...
	public ScaledMenuItem(Action a) {
		super(a);
		Init();
	}
	
	public ScaledMenuItem(Icon icon) {
		super(icon);
		Init();
	}
	...
	public ScaledMenuItem(String text, Icon icon) {
		super(text,icon);
		Init();
	}
	
	public ScaledMenuItem(String text, int mnemonic) {
		super(text,mnemonic);
		Init();
	}
