...
You can find an already compiled **stable** version of the code [here](https://reds-data.heig-vd.ch/logisim-evolution/logisim-evolution.jar).
...
## Documentation
[Here](https://reds-data.heig-vd.ch/logisim-evolution/IntroToLogisimEnglish.pdf)  you can find a tutorial (French version [here](https://reds-data.heig-vd.ch/logisim-evolution/tutoLogisim.pdf)) that explains some basic usage of Logisim. The electronic card referenced in the tutorial is a small card we use in our laboratories -- you won't be able to buy it in a store -- but the descriptions should be good enough to be used for another generic board.
